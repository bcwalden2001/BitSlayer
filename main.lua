...
--
-- The current state of the game is very simple.
--
-- You move a sprite around with the WASD/Arrow keys in a tileset, kill monsters, and pick up items.
-- There is a coin counter, health potion consumption system, and inventory system.
--
-- ...although the last system is still a work in progress as it breaks on different machines.
    ...
    for _, i in ipairs(mobsAndItems) do
        ...
        elseif i.type == types.Types.Potion then
            ...
            if (healthPotion.position.x == targetX and healthPotion.position.y == targetY) then
                if Player.currentHealth < Player.maxHealth then
                    ...
                    potionConsumeSound:setVolume(.1)
        ...
        elseif i.type == types.Types.Weapon then
            ...
            if (weapon.position.x == targetX and weapon.position.y == targetY) then
                ...
                weaponCollectSound:setVolume(.1)
        ...
        elseif i.type == types.Types.Shield then
            ...
            if (shield.position.x == targetX and shield.position.y == targetY) then
                ...
                shieldCollectSound:setVolume(.1)
